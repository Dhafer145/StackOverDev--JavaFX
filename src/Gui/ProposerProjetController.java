...
stm = connection.prepareStatement("insert into proposition_projet(id_user,nom_sujet,cahier_charge,description) values(?,?,?,?)");
stm.setString(1, LoginController.logged+"");
stm.setString(2, tfsujet.getText());
stm.setString(3, tfcahier.getText());
stm.setString(4, tfdescription.getText());
