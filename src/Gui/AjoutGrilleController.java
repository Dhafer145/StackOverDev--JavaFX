...
public class AjoutGrilleController implements Initializable {
    ...
    private final int id_encadrant=LoginController.logged;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        System.out.println(id_encadrant);
        
        try {
            ObservableList<String> options = FXCollections.observableArrayList();
            Connection cnx = Myconn.getInstance().getConnection();
            
            ResultSet rs = cnx.createStatement().executeQuery("select full_name from user where id_user in (select id_etudiant from affectation where id_encadrant_academique="+id_encadrant+")");
            while(rs.next()){
...
//            ObservableList<String> options = FXCollections.observableArrayList("Option 1","Option 2","Option 3");
            ...
            Logger.getLogger(AjoutGrilleController.class.getName()).log(Level.SEVERE, null, ex);
        }
