...
stm = connection.prepareStatement("insert into compte_rendu(id_user,fichier,commentaire) values(?,?,?)");

stm.setString(1, LoginController.logged+"");
stm.setString(2, listview.getText());
stm.setString(3, tfcomm.getText());
