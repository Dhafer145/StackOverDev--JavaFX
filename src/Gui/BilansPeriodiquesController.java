...
//        }
        ...
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/Gui/Bilan.fxml"));
    ...
    public void navigateToEdit(int indexPeriode) {
        bilanService.ind = indexPeriode;
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/Gui/modifierBilan.fxml"));
            Scene scene = new Scene(parent);
            Stage stage = new Stage();
            stage.setScene(scene);
    ...
    public void navigateToAdd(int indexPeriode) {
        bilanService.ind = indexPeriode;
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/Gui/AjoutBilan.fxml"));
            Scene scene = new Scene(parent);
            Stage stage = new Stage();
            stage.setScene(scene);
