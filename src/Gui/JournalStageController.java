...
stm = connection.prepareStatement("insert into journal_projet(id_user,date,tache,avis) values(?,?,?,?)");

stm.setString(1, LoginController.logged+"");
stm.setString(2, ((TextField)date_tache.getEditor()).getText());
stm.setString(3, text_tache.getText());
stm.setString(4, text_avis.getText());
...
//    }
    ...
    public void loadTable(){
        ...
        String req = "Select  id_jp,date,tache,avis from journal_projet where id_user=?";
       
        try {
            
            oblist.clear();
           st = cnx.prepareStatement(req);
            st.setString(1,LoginController.logged+"");
