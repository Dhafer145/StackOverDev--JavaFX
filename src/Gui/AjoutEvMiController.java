...
public class AjoutEvMiController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            ResultSet rs = cnx.createStatement().executeQuery("select full_name from user where id_user in (select id_etudiant from affectation where id_encadrant_entreprise="+id_encadrant+")");
            while(rs.next()){
